...
Table~\ref{tab:bench-results} consolidates the benchmark defined in Section~5. The ten warm repetitions were remarkably stable, with a coefficient of variation below 1\% in end-to-end latency. At the \texttt{medium} level, this corresponds to 28.6 input words per second, or approximately 35~s per 1,000 words.
